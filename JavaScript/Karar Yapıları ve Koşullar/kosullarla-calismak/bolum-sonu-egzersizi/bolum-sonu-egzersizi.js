// Koşullarla Çalışmak Bölüö Sonu Egzersizi:
...
3- ff bilgisinde üzgün surat ikonu çıkart; diüerlerinde ise gülücük olsun :)
...
if (examGrade >= 0 && examGrade <= 100) {
    // Tüm if yapıları buraya gelsin. (Kapsayıcı block)
